...
test('renders name, email, and role when flags are true', () => {
    ...
    render(_jsx(UserProfileCard, { user: mockUser }));
...
test('hides email and role when showEmail and showRole are false', () => {
    ...
    render(_jsx(UserProfileCard, { user: mockUser, showEmail: false, showRole: false }));
...
test('calls onEdit with user ID when Edit is clicked', () => {
    ...
    render(_jsx(UserProfileCard, { user: mockUser, onEdit: handleEdit }));
