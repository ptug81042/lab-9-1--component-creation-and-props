...
test('displays product name and price', () => {
    ...
    render(_jsx(ProductDisplay, { product: mockProduct }));
...
test('shows description when showDescription is true', () => {
    render(_jsx(ProductDisplay, { product: mockProduct, showDescription: true }));
...
test('hides description when showDescription is false', () => {
    render(_jsx(ProductDisplay, { product: mockProduct, showDescription: false }));
...
test('calls onAddToCart when Add to Cart button is clicked', () => {
    ...
    render(_jsx(ProductDisplay, { product: mockProduct, onAddToCart: handleAdd }));
